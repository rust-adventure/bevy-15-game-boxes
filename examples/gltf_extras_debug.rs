//! Loads and renders a glTF file as a scene, and
//! list all the different `gltf_extras`.
...
fn setup(
    ...
    // a barebones scene containing one of each
    // gltf_extra type
    commands.spawn(SceneRoot(
        asset_server.load(
            GltfAssetLabel::Scene(1)
                .from_asset("misc-001/misc-001.glb"),
        ),
    ));
