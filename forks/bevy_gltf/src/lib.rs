...
use bevy_reflect::{
    std_traits::ReflectDefault, Reflect, TypePath,
};
use bevy_render::{
    mesh::{
        skinning::SkinnedMeshInverseBindposes, Mesh,
        MeshVertexAttribute,
    },
...
impl Plugin for GltfPlugin {
    fn build(&self, app: &mut App) {
        app.register_type::<GltfExtras>()
            ...
            .init_asset::<GltfMesh>()
            .init_asset::<GltfSkin>()
            .preregister_asset_loader::<GltfLoader>(&[
                "gltf", "glb",
            ]);
    }

    fn finish(&self, app: &mut App) {
        let supported_compressed_formats = match app
            .world()
            .get_resource::<RenderDevice>()
        {
            Some(render_device) => {
                CompressedImageFormats::from_features(
...
impl GltfNode {
    ...
    #[cfg(feature = "bevy_animation")]
    pub fn with_animation_root(
        self,
        is_animation_root: bool,
    ) -> Self {
        Self {
            is_animation_root,
            ..self
